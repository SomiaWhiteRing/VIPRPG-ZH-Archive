/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 24b28b5a1cfc75734f273c87f3cad61f)
// Runtime types generated with workerd@1.20260915.1 2026-04-30 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	...
	ASSETS: Fetcher;
	EMAIL_FROM: "noreply@viprpg.org" | "viparc@shatranj.space";
	APP_ORIGIN: "https://staging.viprpg.org" | "https://viprpg-zh-archive.q578235562.workers.dev";
	SITE_NOINDEX: "true" | "false";
	VIEW_STATS: DurableObjectNamespace<import("./worker").ViewStats>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker");
		durableNamespaces: "ViewStats";
	}
	interface StagingEnv {
		...
		VIEW_RATE_LIMITER: RateLimit;
		ASSETS: Fetcher;
		EMAIL_FROM: "noreply@viprpg.org";
		APP_ORIGIN: "https://staging.viprpg.org";
		SITE_NOINDEX: "true";
		VIEW_STATS: DurableObjectNamespace<import("./worker").ViewStats>;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "EMAIL_FROM" | "APP_ORIGIN" | "SITE_NOINDEX">> {}
}
