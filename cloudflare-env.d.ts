/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 162f34c5eed87f4203e7d86bf881aff2)
...
declare namespace Cloudflare {
	interface StagingEnv {
		...
		WORKER_SELF_REFERENCE: Fetcher /* <staging-worker-name> */;
	}
	interface Env {
		ARCHIVE_BUCKET: R2Bucket;
		DB: D1Database;
		...
		TURNSTILE_SITE_KEY: "<turnstile-site-key>";
		EMAIL_FROM: "noreply@example.com";
		APP_ORIGIN: "https://<staging-worker-domain>" | "https://<production-worker-domain>";
		WORKER_SELF_REFERENCE: Fetcher /* <staging-worker-name> */ | Fetcher /* viprpg-zh-archive */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TURNSTILE_SITE_KEY" | "EMAIL_FROM" | "APP_ORIGIN">> {}
}
