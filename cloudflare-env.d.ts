/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 445405d148123f481cf440db7de8ba22)
...
declare namespace Cloudflare {
	...
	interface StagingEnv {
		...
		ASSETS: Fetcher;
		EMAIL_FROM: "viparc@shatranj.space";
		APP_ORIGIN: "https://viprpg-zh-archive-staging.q578235562.workers.dev";
		WORKER_SELF_REFERENCE: Fetcher /* viprpg-zh-archive-staging */;
	}
	interface Env {
		ARCHIVE_BUCKET: R2Bucket;
		DB: D1Database;
		...
		ASSETS: Fetcher;
		EMAIL_FROM: "viparc@shatranj.space";
		APP_ORIGIN: "https://viprpg-zh-archive-staging.q578235562.workers.dev" | "https://viprpg-zh-archive.q578235562.workers.dev";
		WORKER_SELF_REFERENCE: Fetcher /* viprpg-zh-archive-staging */ | Service<typeof import("./worker").default>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "EMAIL_FROM" | "APP_ORIGIN">> {}
}
