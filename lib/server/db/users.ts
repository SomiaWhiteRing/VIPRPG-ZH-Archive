...
import { USER_ACCESS_COLUMNS, USER_ACCESS_JOINS, mapUserAccessRows, mapProfileVisibility, type UserRow, type UserAccessRow, type ProfileVisibilityRow, type UserStatus, type ArchiveUser } from "./user-access";
export type { ArchiveUser, UserStatus } from "./user-access";
...
export async function findActiveUserBySessionHash(sessionHash: string): Promise<{
  ...
  return findActiveSessionByHash(getD1(), sessionHash);
}
