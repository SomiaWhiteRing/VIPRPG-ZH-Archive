import { countGameWorks, listGameWorks } from "@/app/.server/db/game-library";
import {
  ...
  return (
    <PageContainer>
      ...
      <div className="grid gap-x-9 pb-11 min-[981px]:grid-cols-[minmax(0,1fr)_252px]">
        ...
        <aside
          className="mt-5 rounded-lg border border-border bg-muted/5 p-3 min-[981px]:sticky min-[981px]:top-18.5 min-[981px]:mt-1 min-[981px]:self-start min-[981px]:border-0 min-[981px]:bg-transparent min-[981px]:p-0"
          aria-label="游戏筛选"
        >
