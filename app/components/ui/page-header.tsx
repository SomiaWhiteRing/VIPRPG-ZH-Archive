    ...
    >
      <div className="min-w-0">
        ...
        <h1
          ...
          className={
            compact
              ? "m-0 font-display text-[clamp(24px,3vw,30px)] font-bold leading-[1.2]"
              : "m-0 text-3xl font-extrabold tracking-tight md:text-4xl"
          }
        >
          {title}
        </h1>
        {subtitle ? (
          <div
            className={
              compact ? "mt-1.5 text-sm text-muted" : "mt-2 text-muted"
            }
          >
            {subtitle}
          </div>
