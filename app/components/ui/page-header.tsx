...
export function PageHeader({ eyebrow, title, titleId, subtitle, actions, compact = false }: PageHeaderProps) {
  return (
    <header className={compact ? "flex flex-wrap items-end justify-between gap-4 border-b border-border pb-4" : "mb-8 flex flex-wrap items-end justify-between gap-4 border-b border-border pb-6"} data-slot="page-header">
      <div className="min-w-0">
        ...
        <h1 id={titleId} className={compact ? "m-0 font-display text-[clamp(24px,3vw,30px)] font-bold leading-[1.2]" : "m-0 text-3xl font-extrabold tracking-tight md:text-4xl"}>{title}</h1>
