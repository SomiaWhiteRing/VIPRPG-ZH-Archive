...
export function handleComboboxNavigation(
...
export function ComboboxOptions({
  ...
  children,
  ...props
}: ComponentProps<"div"> & { activeIndex: number }) {
  ...
  return (
    <div
      ...
      role="listbox"
      className={cn(
        "absolute inset-x-0 top-[calc(100%+0.25rem)] z-30 max-h-64 overflow-y-auto rounded-md border border-border bg-card p-1 shadow-surface",
        className,
      )}
      {...props}
    >
